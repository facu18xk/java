...
/**
 * Ejemplo b�sico del funcionamiento del robot, conos, y recipientes de conos.
 * <p>
 *
...
public class EjemploGeneral {
     ...
     *
     * @param arg Argumentos desde la l�nea de comandos (no necesarios).
     * @throws InterruptedException Excepcion que puede ser lanzada por el
     *                              Thread.sleep
     */
     ...
     * 
     * @param carlitos Robot que dar� la media vuelta.
     */
     ...
     * 
     * @param carlitos Robot que dar� cierta cantidad de pasos.
     * 
    ...
    /**
     * M�todo encargado de ejecutar el baile de despedida.
     * 
