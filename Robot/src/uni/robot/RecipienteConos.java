...
public class RecipienteConos implements IFigura {
     ...
     * @param cantMax     La cantidad maxima de conos que puede contener el
     *                    recipiente.
    ...
    private void cargarImagenPrimeraVez() {
        ...
        try {
            ...
            error(
                    "Error al cargar imagen. RecipienteConos no est� bien instalado.");
        }
    }
     ...
     */
    /*
     * M�todo encargado de verificar la cantidad inicial de conos en el recipiente.
     * 
     * @param cantMax cantidad m�xima de conos.
     * 
