...
public class MundoConTexto extends Mundo {
     ...
     * @param tituloMundo  String Frase utilizada en la barra de titulo de la
     *                     ventana
     ...
     * @param indice int La posici�n de la letra.
     */
    /**
    ...
    public void setColor(Color c, int indice) {
        ...
        if (indice < 0 | indice > texto.length()) {
            throw new RuntimeException(
                    "El n�mero est� fuera de rango!\nMayor que el tama�o de la palabra, o negativo");
        }
    ...
    /*
     * Metodo encargado de armar el html encargado de los colores en el area de
     * texto.
     * Vease que el area de texto en realidad es un JLabel, y este tipo de
     * componente
     * soporta HTML.
     *
