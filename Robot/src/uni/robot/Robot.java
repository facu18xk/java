 ...
 * en un mundo poco emocionante, no existen cafeter�as, tampoco cines, (es un
 * mundo finito rodeado de paredes de s�lido NEUTRONIUN impenetrable), pero
 ...
 * cintura. Carlos es un robot m�s dentro de la gran comunidad. Como todos
 * los que all� residen, al comenzar solo sabe hacer unas pocas acciones. Con
 * el tiempo lo ayudaremos a integrarse de manera m�s eficiente.
 *
 * <p>
 ...
 * obst�culos (no muy complejos, pero al fin molestos) que debe superar.
 *
 * <p>
 * La finalidad de los UNIBOTS es realizar las tareas para su due�o. Cuando
 * necesitan determinar la cantidad de conos que poseen, solo tienen que
 * ingresar su brazo en la bolsa y contar.
 *
 * <p>
 * Los conos son peque�os se�alizadores pl�sticos y est�n colocados �nicamente
 ...
 * generalmente ocupamos uno a la vez. Al contrario de los obst�culos, los
 * conos no interfieren con el recorrido de los UNIBOTS, pero solo puede
 * haber un cono por intersecci�n. Los contenedores, son recipientes con uno,
 * varios, o ning�n cono en su interior.
 *
 * <p>
 * Carlos ejecuta las instrucciones dadas por su due�o en forma secuencial.
 *
...
public class Robot implements IFigura {
    ...
    public void guardarCono() {
        ...
        // pido un arreglo con todas las figuras que exiten en la posicion actual de mi
        // robot
    ...
    /**
     * Este metodo sirve para determinar si hay un cono en la posicion actual del
     * robot
     *
    ...
    /**
     * Este metodo sirve para determinar si hay un RecipienteConos en la posicion
     * actual del robot
     *
    ...
    /**
     * Metodo que revisa la cantidad Maxima de conos que puede poseer el robot en su
     * bolsita.
     *
    ...
    /*
     * M�todo encargado de validar que el mundo no sea null.
     *
     * @param mundo Mundo
     */
