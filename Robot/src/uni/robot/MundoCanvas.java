...
class MundoCanvas extends Canvas {
    ...
    /**
     * El m�todo paint es utilizado para dibujar las figuras en el mundo
     * Recibimos un contexto gr�fico (g) y en el podemos dibujar cualquier cosa.
     * <p>
     * Para el movimiento se utiliza la t�cnica de doble buffer.
     *
    ...
    /**
     * M�todo encargado de verificar que la direcci�n del robot sea v�lida.
     *
     * @param r Robot cuya direcci�n se va a verificar.
     */
    ...
    /**
     * M�todo encargado de verificar que la posici�n del robot sea v�lida.
     *
     * @param figura Figura cuya posici�n se va a verificar.
     */
    void verificarPosicionInicial(IFigura figura) {

        // si la columna inicial del robot es mayor que la cantidad de columnas en el
        // mundo
    ...
    /*
     * Metodo encargado de transformar las filas en coordenadas Y para representar
     * en pantalla
     *
    ...
    /*
     * Metodo encargado de transformar las columnas en coordenadas X para
    ...
    private void paint(Graphics g, IFigura figuraCambiada,
         ...
         *
         */
        /** @todo seperar el doble buffer en un metodo que dise�e el fondo */
        if (null == buffer || null == buffer2 || null == gContext ||
            ...
            if (fondoTablero) {
                ...
                for (int i = 1; i <= this.cantFilas; i++) {
                    ...
                    gContext.drawString(str,
                            ESPACIO_NUMEROS -
                                    gContext.getFontMetrics().stringWidth(str),
        ...
        for (int z = 0; z < listaFiguras.size(); z++) {
            ...
            // Aqui decide si pintar la imagen con coordenadas cartesianas o en fila y
            // columnas.
            if (f == figuraCambiada) {
