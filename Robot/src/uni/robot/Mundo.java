...
public class Mundo extends Frame {
    ...
    public Mundo(String tituloMundo, int cantFilas, int cantColumnas) {
        ...
        // Coloco el �cono en el mundo.
        try {
            this.setIconImage(ImageIO.read(this.getClass().getClassLoader().getResource("imagenes" +
    ...
    Mundo(String tituloMundo, int cantFilas, int cantColumnas,
        ...
        // Coloco el �cono en el mundo.
        try {
            this.setIconImage(ImageIO.read(this.getClass().getClassLoader().getResource(imagen)));
        } catch (IOException e) {
            new RuntimeException("error al cargar el icono de la ventana");
        }
    ...
    /**
     * Este m�todo infelizmente debe ser publico, debido a que sobrescribo
    ...
    /**
     * Este metodo se encarga de todo el trabajo sucio de configuracion de la
     * ventana.
     */
    protected void configurarVentana() {
        this.setTitle(tituloMundo); // Pongo titulo a la ventana

        this.setResizable(false); // Indico que la ventana no puede cambiar de tama�o
        this.setSize(baseMundo, alturaMundo); // Indico el tama�o de la ventana
